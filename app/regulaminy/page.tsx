    ...
    return (
        <main className="space-y-4 px-4">
            ...
            <ol className="list-decimal list-outside space-y-4 text-lg">
                ...
                <li><span className="font-bold">Płatność – </span>Opłacamy jedno spotkanie do przodu – stałe osoby najpóźniej w dniu najbliższego spotkania, a nowe mają dodatkowe 7 dni od pierwszego spotkania na decyzję i opłatę; brak wpłaty oznacza zwolnienie miejsca. Jeśli wiesz, że nie będzie Cię na najbliższym spotkaniu, możesz zgłosić urlop najpóźniej 2 tygodnie wcześniej – wtedy płatność przechodzi na kolejne spotkanie, a Twoje miejsce zostaje zachowane. W przeciwnym razie nieobecność nie zwalnia z opłaty.</li>
